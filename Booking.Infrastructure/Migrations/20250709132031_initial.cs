        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_LocationDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Properties_Cities_Address_CityId",
                        column: x => x.Address_CityId,
                        principalTable: "Cities",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Properties_Countries_Address_CountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImageProperty", x => new { x.ImagesId, x.PropertiesId });
                    table.ForeignKey(
                        name: "FK_ImageProperty_Images_ImagesId",
                        column: x => x.ImagesId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ImageProperty_Properties_PropertiesId",
                        column: x => x.PropertiesId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImageProperty_PropertiesId",
                table: "ImageProperty",
                column: "PropertiesId");

            migrationBuilder.CreateIndex(
                name: "IX_Properties_Address_CityId",
                table: "Properties",
                column: "Address_CityId");

            migrationBuilder.CreateIndex(
                name: "IX_Properties_Address_CountryId",
                table: "Properties",
